...
local _2amodule_name_2a = "conjure-locstack.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("conjure-locstack.aniseed.compile"), autoload("conjure-locstack.aniseed.fennel"), autoload("conjure-locstack.aniseed.fs"), autoload("conjure-locstack.aniseed.nvim")
