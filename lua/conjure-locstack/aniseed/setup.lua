...
local _2amodule_name_2a = "conjure-locstack.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-locstack.aniseed.core"), autoload("conjure-locstack.aniseed.env"), autoload("conjure-locstack.aniseed.eval"), autoload("conjure-locstack.aniseed.nvim")
