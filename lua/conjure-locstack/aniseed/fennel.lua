...
local _2amodule_name_2a = "conjure-locstack.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("conjure-locstack.aniseed.core"), autoload("conjure-locstack.aniseed.fs"), autoload("conjure-locstack.aniseed.nvim"), autoload("conjure-locstack.aniseed.string")
...
local function impl()
  local compiler = require("conjure-locstack.aniseed.deps.fennel")
