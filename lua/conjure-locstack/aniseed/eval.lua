...
local _2amodule_name_2a = "conjure-locstack.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-locstack.aniseed.core"), autoload("conjure-locstack.aniseed.compile"), autoload("conjure-locstack.aniseed.fennel"), autoload("conjure-locstack.aniseed.fs"), autoload("conjure-locstack.aniseed.nvim")
