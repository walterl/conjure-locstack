...
local _2amodule_name_2a = "conjure-locstack.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("conjure-locstack.aniseed.core"), autoload("conjure-locstack.aniseed.fennel"), autoload("conjure-locstack.aniseed.fs"), autoload("conjure-locstack.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "conjure-locstack.aniseed.macros"
  local filename
  do
